...
<div class="w-full bg-neutral-secondary-medium border border-default-medium rounded-base">
    <div class="p-2 border-b border-default-medium">
        <div class="flex flex-wrap items-center">
            <div class="flex items-center space-x-1 rtl:space-x-reverse flex-wrap">
                <button id="toggleBoldButton" data-tooltip-target="tooltip-bold"  data-tooltip-placement="bottom" type="button" class="p-1.5 text-body rounded-sm cursor-pointer hover:text-heading hover:bg-neutral-quaternary">
                ...
                <button id="toggleItalicButton" data-tooltip-target="tooltip-italic" data-tooltip-placement="bottom" type="button" class="p-1.5 text-body rounded-sm cursor-pointer hover:text-heading hover:bg-neutral-quaternary">
                ...
                <button id="toggleUnderlineButton" data-tooltip-target="tooltip-underline" data-tooltip-placement="bottom" type="button" class="p-1.5 text-body rounded-sm cursor-pointer hover:text-heading hover:bg-neutral-quaternary">
                ...
                <button id="toggleStrikeButton" data-tooltip-target="tooltip-strike" data-tooltip-placement="bottom" type="button" class="p-1.5 text-body rounded-sm cursor-pointer hover:text-heading hover:bg-neutral-quaternary">
                ...
                <button id="toggleHighlightButton" data-tooltip-target="tooltip-highlight" data-tooltip-placement="bottom" type="button" class="p-1.5 text-body rounded-sm cursor-pointer hover:text-heading hover:bg-neutral-quaternary">
                ...
                <button id="toggleLinkButton" data-tooltip-target="tooltip-link" data-tooltip-placement="bottom" type="button" class="p-1.5 text-body rounded-sm cursor-pointer hover:text-heading hover:bg-neutral-quaternary">
                ...
                <button id="removeLinkButton" data-tooltip-target="tooltip-remove-link" data-tooltip-placement="bottom" type="button" class="p-1.5 text-body rounded-sm cursor-pointer hover:text-heading hover:bg-neutral-quaternary">
                ...
                <button id="toggleTextSizeButton" data-dropdown-toggle="textSizeDropdown" data-tooltip-placement="bottom" type="button" data-tooltip-target="tooltip-text-size" class="p-1.5 text-body rounded-sm cursor-pointer hover:text-heading hover:bg-neutral-quaternary">
                ...
                <button id="toggleTextColorButton" data-dropdown-toggle="textColorDropdown" type="button" data-tooltip-placement="bottom" data-tooltip-target="tooltip-text-color" class="p-1.5 text-body rounded-sm cursor-pointer hover:text-heading hover:bg-neutral-quaternary">
                ...
                <button id="toggleFontFamilyButton" data-dropdown-toggle="fontFamilyDropdown" type="button" data-tooltip-placement="bottom" data-tooltip-target="tooltip-font-family" class="p-1.5 text-body rounded-sm cursor-pointer hover:text-heading hover:bg-neutral-quaternary">
                ...
                <button id="toggleLeftAlignButton" type="button" data-tooltip-target="tooltip-left-align" data-tooltip-placement="bottom" class="p-1.5 text-body rounded-sm cursor-pointer hover:text-heading hover:bg-neutral-quaternary">
                ...
                <button id="toggleCenterAlignButton" type="button" data-tooltip-target="tooltip-center-align" data-tooltip-placement="bottom" class="p-1.5 text-body rounded-sm cursor-pointer hover:text-heading hover:bg-neutral-quaternary">
                ...
                <button id="toggleRightAlignButton" type="button" data-tooltip-target="tooltip-right-align" data-tooltip-placement="bottom" class="p-1.5 text-body rounded-sm cursor-pointer hover:text-heading hover:bg-neutral-quaternary">
    ...
    <div class="flex items-center gap-2 pt-2 flex-wrap">
        ...
        <button id="addImageButton" type="button" data-tooltip-target="tooltip-image" data-tooltip-placement="bottom" class="p-1.5 text-body rounded-sm cursor-pointer hover:text-heading hover:bg-neutral-quaternary">
            ...
            <button id="addVideoButton" type="button" data-tooltip-target="tooltip-video" data-tooltip-placement="bottom" class="p-1.5 text-body rounded-sm cursor-pointer hover:text-heading hover:bg-neutral-quaternary">
            ...
            <button id="toggleListButton" type="button" data-tooltip-target="tooltip-list" data-tooltip-placement="bottom" class="p-1.5 text-body rounded-sm cursor-pointer hover:text-heading hover:bg-neutral-quaternary">
        ...
        <button id="toggleOrderedListButton" type="button" data-tooltip-target="tooltip-ordered-list" data-tooltip-placement="bottom" class="p-1.5 text-body rounded-sm cursor-pointer hover:text-heading hover:bg-neutral-quaternary">
        ...
        <button id="toggleBlockquoteButton" type="button" data-tooltip-target="tooltip-blockquote-list" data-tooltip-placement="bottom" class="p-1.5 text-body rounded-sm cursor-pointer hover:text-heading hover:bg-neutral-quaternary">
        ...
        <button id="toggleHRButton" type="button" data-tooltip-target="tooltip-hr-list" data-tooltip-placement="bottom" class="p-1.5 text-body rounded-sm cursor-pointer hover:text-heading hover:bg-neutral-quaternary">
