...
<div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
    ...
    <button data-modal-target="add-news-modal" data-modal-toggle="add-news-modal"  type="button" class="inline-flex items-center  text-white bg-brand hover:bg-brand-strong box-border border border-transparent focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded-base text-sm px-4 py-2.5 focus:outline-none">
   ...
   <span class="flex-1 text-center whitespace-nowrap p-2">
    ...
    <x-layouts.popup-template title="اضافة خبر جديد" id="add-news-modal">
